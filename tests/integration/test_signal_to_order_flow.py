...
class TestSignalToOrderFlow:
    ...
    def test_multiple_signals_create_multiple_orders(self, context, manager_service, event_bus):
    ...
    def test_signal_intention_mapping(self, context, manager_service, event_bus):
