...
from qtrader.events.event_store import InMemoryEventStore, SQLiteEventStore, register_event_class, resolve_event_class
...
class TestEventStoreSerialization:
    ...
    def test_decimal_precision_preserved(self, event_store):
        ...
        assert retrieved.cumulative_price_factor == Decimal("1.23456789")
