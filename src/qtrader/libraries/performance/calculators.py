...
Usage:
    >>> from qtrader.libraries.performance.calculators import DrawdownCalculator
...
from qtrader.libraries.performance.models import DrawdownPeriod, TradeRecord
...
class PeriodAggregationCalculator:
    ...
    def calculate_periods(
        ...
        """
        from qtrader.libraries.performance.models import PeriodMetrics
...
class StrategyPerformanceCalculator:
    ...
    def calculate_performance(self) -> list:
        ...
        from qtrader.libraries.performance.models import StrategyPerformance
