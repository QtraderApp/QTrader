...
class AdapterRegistry(BaseRegistry):
    ...
    - Built-in adapters: qtrader.services.data.adapters.builtin/
    ...
    def discover(self, custom_path: str | None = None) -> None:
        ...
        Discovery order:
        1. Built-in adapters (qtrader.services.data.adapters.builtin/)
    ...
    def _discover_builtin(self) -> None:
        """Discover built-in adapters from qtrader.services.data.adapters.builtin/."""
        try:
            import qtrader.services.data.adapters.builtin as builtin_module
