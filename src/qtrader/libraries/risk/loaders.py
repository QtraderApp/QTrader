...
def load_policy(name: str, custom_path: str | None = None) -> RiskConfig:
    ...
    2. Built-in policies: src/qtrader/libraries/risk/builtin/{name}.yaml
    ...
    # Path from this file: src/qtrader/libraries/risk/loaders.py
    # Need to go up 4 levels to reach project root
    module_dir = Path(__file__).parent
    project_root = (
        module_dir.parent.parent.parent.parent
    )  # src/qtrader/libraries/risk -> src -> qtrader -> libraries -> risk
