...
See src/qtrader/services/data/adapters/builtin/yahoo_csv.py for complete example.
"""
...
class MyDataAdapter:
    ...
    Data adapters implement the IDataAdapter protocol to integrate with QTrader.
    ...
    def load_bars(
        ...
        This is the main method that QTrader calls to fetch market data.
