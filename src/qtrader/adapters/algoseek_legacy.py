"""
DEPRECATED: Legacy Algoseek OHLC adapter - DO NOT USE.

This is the old adapter that returns Bar model (multi-series NamedTuple).
It is kept for reference during migration but should not be used in new code.

Use AlgoseekOHLCVendorAdapter instead:
    from qtrader.adapters.algoseek import AlgoseekOHLCVendorAdapter

Migration Status:
- Phase 1-2: Complete (new data layer + iterator infrastructure)
- Phase 3: NEW AlgoseekOHLCVendorAdapter created (returns AlgoseekBar)
- Phase 4-9: Remaining phases (backtest, execution, tests, cleanup)

This file will be deleted after Phase 9 cleanup.
"""
...
warnings.warn(
    "algoseek_legacy.py is deprecated. Use AlgoseekOHLCVendorAdapter instead. "
    "This module will be removed after Phase 9 migration cleanup.",
    DeprecationWarning,
    stacklevel=2,
)
...
class AlgoseekOHLCAdapterLegacy:
    """
